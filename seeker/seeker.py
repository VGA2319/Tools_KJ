...
╚██╗ ██╔╝██║   ██║██╔══██║
 ╚████╔╝ ╚██████╔╝██║  ██║
  ╚═══╝   ╚═════╝ ╚═╝  ╚═╝"""
    ...
    utils.print(f'{G}[>] {W}|         Selamat datang di Tools VGA          |')
    utils.print(f'{G}[>] {W}| Alat analisis dan pelacakan berbasis presisi |')
    utils.print(f'{G}[>] {W}|       Lokasi bukan lagi sekadar asumsi       |')
    utils.print(f'{G}')
    utils.print(f'{G}[>] {C}Created By   : {W}Valbian Gery Adi')
